...
import { Options, Result, UserMetadata, HashtagMetadata, PostCollector, HistoryItem, MusicMetadata } from './types';
export declare const hashtag: (input: string, options?: Options | undefined, maxCursor?: number | undefined) => Promise<Result>;
export declare const user: (input: string, options?: Options | undefined, maxCursor?: number | undefined) => Promise<Result>;
export declare const trend: (input: string, options?: Options | undefined, maxCursor?: number | undefined) => Promise<Result>;
export declare const music: (input: string, options?: Options | undefined, maxCursor?: number | undefined) => Promise<Result>;
