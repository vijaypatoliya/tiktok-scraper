...
class TikTokScraper extends events_1.EventEmitter {
    ...
    async scrape() {
        ...
        return Object.assign(Object.assign(Object.assign(Object.assign(Object.assign({ headers: this.headers, collector: this.collector, maxCursor: this.maxCursor }, (this.download ? { zip } : {})), (this.filetype === 'all' ? { json, csv } : {})), (this.filetype === 'json' ? { json } : {})), (this.filetype === 'csv' ? { csv } : {})), (this.webHookUrl ? { webhook: this.httpRequests } : {}));
    }
    withoutWatermark() {
